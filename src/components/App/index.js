      ...
      <div>
          ...
          <div className="row">
            ...
            <div className="col-6">
              <div className="article-text-content">
                ...
                <p className="paragraph text-muted">It only takes a few minutes to start adding commerce to your platform. To manage payments, you can set up Stripe accounts for sellers from 25 countries (more coming soon). Or own the look and feel yourself and have sellers do everything within your platform.</p>
                <p className="paragraph text-muted">With Stripe, Squarespace went from a site-builder to a store-builder—growing its customer base by becoming more useful to more people. And thousands of other platforms around the world are bringing payments in-house with Stripe.</p>
        ...
        <div className="bg-blue section-padding">
          <div className="container">
            ...
            <div className="row">
              <div className="col-5">
                <p className="parafgraph text-muted">Payments for <span>market­places</span> used to be hard: accounting for seller earnings, making en-masse payouts happen (on time!), managing 1099-Ks and tax reporting, regulatory compliance. Marketplaces shouldn’t have to build all that from scratch, so we made Stripe Connect to provide all the tools you need to run a multi-sided marketplace.</p>
              </div>
              <div className="col-5 col-offset-2">
                <p className="paragraph text-muted">Integrating Connect means always having access to the state-of-the-art. In October 2015, we started piloting <a href="">instant debit card transfers</a>. And Connect is now available to marketplaces in <a href="">25 countries</a>.</p>
                <hr className="hr-muted hr-lg"/>
                <ul className="nav nav-vertical">
